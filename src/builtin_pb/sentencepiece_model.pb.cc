...
constexpr TrainerSpec::TrainerSpec(
  ...
  , eos_piece_(nullptr)
  , pad_piece_(nullptr)
  , pretokenization_delimiter_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , seed_sentencepieces_file_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
void TrainerSpec::InternalSwap(TrainerSpec* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &pretokenization_delimiter_, lhs_arena,
      &other->pretokenization_delimiter_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &seed_sentencepieces_file_, lhs_arena,
      &other->seed_sentencepieces_file_, rhs_arena
  );
